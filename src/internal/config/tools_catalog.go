...
var Tools = []Tool{
	...
	{
		Name:         "ripgrep",
		Description:  "Fast grep, the rg agents and editors shell out to",
		Replaces:     "grep (what agent and editor tools call)",
		Command:      "rg",
		Formula:      "ripgrep",
		Method:       InstallBrewFormula,
		Category:     CategoryCLITools,
	...
	{
		Name:         "tgrep",
		Description:  "Trigram-indexed grep for large codebases",
		Replaces:     "grep -r",
		Command:      "tgrep",
		Formula:      "tgrep",
		Method:       InstallBrewFormula,
		Category:     CategoryCLITools,
		Dependencies: []string{"homebrew"},
		VersionFn:    tool.VersionFromCmd("tgrep", []string{"--version"}, tool.ParseBrewVersion),
	},
	{
		Name:         "sd",
