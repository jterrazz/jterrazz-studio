...
The Configuration tab groups items by category (Server only appears when the current machine is registered as `server` — see [Machines](06-machines.md)):
...
- [Tools and skills](08-tools-and-skills.md) — the Skills tab and the underlying registries.
- [Machines](06-machines.md) — how the machine role gates which items appear.
